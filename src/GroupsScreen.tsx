...
export function GroupsScreen({ store, mode, editor, setEditor, onGroups, onCards, onBrowse, onPageChange }: { store: StoredState; mode: 'groups' | 'stacks'; editor?: VerseStack; setEditor: Dispatch<SetStateAction<VerseStack | undefined>>; onGroups: () => void; onCards: () => void; onBrowse: (scope: 'all' | 'learning' | 'saved') => void; onPageChange: () => void }) {

...
export function PracticeGames({ verses, enabled, onClose, onNext }: { verses: Verse[]; enabled: boolean; onClose: () => void; onNext: () => void }) {

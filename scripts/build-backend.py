...
def build_template():
    ...
    resources['GroupPreflightRoute'] = {'Type': 'AWS::ApiGatewayV2::Route', 'Properties': {'ApiId': ref('HttpApi'), 'RouteKey': 'OPTIONS /groups/{proxy+}', 'AuthorizationType': 'NONE', 'Target': {'Fn::Join': ['/', ['integrations', ref('Integration')]]}}}
